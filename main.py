...
def special(char_name: str, char_class: str) -> str:
    """Расчитывает применение специального умения."""
...
def start_training(char_name: str, char_class: str) -> str:
    """Функция, отвечающая за информацию, после выбора класса."""
    if char_class == 'warrior':
...
def choice_char_class() -> str:
    """Функция, отвечающая за выбор класса."""
    approve_choice: str = ''
    char_class: str = ''
